drop table if exists GL_UNGENPOST_HIST;
/*==============================================================*/
/* Table: GL_UNGENPOST_HIST                                           */
/*==============================================================*/
create table GL_UNGENPOST_HIST
(
    ...
    TASK_ID varchar(50) comment '运行节点',
    COMPANY varchar(20) comment '法人代码'
);
alter table GL_UNGENPOST_HIST comment '未生成会计分录流水表 undefined';