drop table if exists MB_PCP_INNER_PRICE;
/*==============================================================*/
/* Table: MB_PCP_INNER_PRICE                                           */
/*==============================================================*/
create table MB_PCP_INNER_PRICE
(
    ...
    primary  key (GROUP_ID,CLIENT_NO,INTERNAL_KEY)
);
alter table MB_PCP_INNER_PRICE comment '资金池账户计价表 undefined';