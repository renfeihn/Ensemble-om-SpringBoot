drop table if exists MB_FINANCIAL_IN_DETAIL;
/*==============================================================*/
/* Table: MB_FINANCIAL_IN_DETAIL                                           */
/*==============================================================*/
create table MB_FINANCIAL_IN_DETAIL
(
    ...
    TRAN_IN_DATE varchar(8) comment '转入日期',
    TRAN_IN_AMT Decimal(17,2) comment '转入金额',
...
alter table MB_FINANCIAL_IN_DETAIL comment '理财转入明细表 undefined';