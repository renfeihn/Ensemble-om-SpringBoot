drop table if exists FX_MB_EXCHANGE_TRAN_ATTACH;
/*==============================================================*/
/* Table: FX_MB_EXCHANGE_TRAN_ATTACH                                           */
/*==============================================================*/
create table FX_MB_EXCHANGE_TRAN_ATTACH
(
...
alter table FX_MB_EXCHANGE_TRAN_ATTACH comment '结售汇交易流水附属表 undefined';