drop table if exists MM_DETAIL_HIST;
/*==============================================================*/
/* Table: MM_DETAIL_HIST                                           */
/*==============================================================*/
create table MM_DETAIL_HIST
(
    SEQ_NO varchar(50) not null comment '交易序号',
    EVENT_TYPE varchar(50) not null comment '事件类型 TAK 拆入 PLC 拆出',
    TRAN_TYPE varchar(10) comment '交易类型  MAT-到期 VAL-起息 PRE-提起支还',
...
alter table MM_DETAIL_HIST comment 'MM交易流水表信息 undefined';