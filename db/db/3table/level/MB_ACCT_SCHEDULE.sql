drop table if exists MB_ACCT_SCHEDULE;
/*==============================================================*/
/* Table: MB_ACCT_SCHEDULE                                           */
/*==============================================================*/
create table MB_ACCT_SCHEDULE
(
...
alter table MB_ACCT_SCHEDULE comment '账户计划表 undefined';

drop index MB_ACCT_SCH_IND2 on MB_ACCT_SCHEDULE;
/*==============================================================*/
/* Index: MB_ACCT_SCH_IND2                                           */
/*==============================================================*/
create index MB_ACCT_SCH_IND2 on MB_ACCT_SCHEDULE (
    INTERNAL_KEY,NEXT_DEAL_DATE
);