drop table if exists MB_ACCT_SCHEDULE_AMEND_HIST;
/*==============================================================*/
/* Table: MB_ACCT_SCHEDULE_AMEND_HIST                                           */
/*==============================================================*/
create table MB_ACCT_SCHEDULE_AMEND_HIST
(
...
alter table MB_ACCT_SCHEDULE_AMEND_HIST comment '账户计划变更历史表 undefined';