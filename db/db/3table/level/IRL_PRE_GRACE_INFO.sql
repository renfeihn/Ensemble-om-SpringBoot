drop table if exists IRL_PRE_GRACE_INFO;
/*==============================================================*/
/* Table: IRL_PRE_GRACE_INFO                                           */
/*==============================================================*/
create table IRL_PRE_GRACE_INFO
(
...
alter table IRL_PRE_GRACE_INFO comment '贷款宽限期到期信息表 undefined';