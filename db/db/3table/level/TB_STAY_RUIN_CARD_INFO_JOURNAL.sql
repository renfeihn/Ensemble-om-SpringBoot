drop table if exists TB_STAY_RUIN_CARD_INFO_JOURNAL;
/*==============================================================*/
/* Table: TB_STAY_RUIN_CARD_INFO_JOURNAL                                           */
/*==============================================================*/
create table TB_STAY_RUIN_CARD_INFO_JOURNAL
(
    CARD_NO varchar(50) comment '待销毁卡号',
    ...
    CARD_TYPE varchar(1) comment '待销毁卡类型',
    CARD_STATUS varchar(3) comment '卡状态',
...
alter table TB_STAY_RUIN_CARD_INFO_JOURNAL comment '待销毁卡管理登记流水表 undefined';