drop table if exists IRL_AFTER_ACCT_MATRIX;
/*==============================================================*/
/* Table: IRL_AFTER_ACCT_MATRIX                                           */
/*==============================================================*/
create table IRL_AFTER_ACCT_MATRIX
(
    ...
    primary  key (MATRIX_NO,SYSTEM_ID)
);
alter table IRL_AFTER_ACCT_MATRIX comment '分户利率阶梯信息表 undefined';