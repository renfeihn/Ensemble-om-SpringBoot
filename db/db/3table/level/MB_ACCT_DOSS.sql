drop table if exists MB_ACCT_DOSS;
/*==============================================================*/
/* Table: MB_ACCT_DOSS                                           */
/*==============================================================*/
create table MB_ACCT_DOSS
(
    ...
    DOSS_DATE varchar(8) comment '转久悬日期',
    OUT_DATE varchar(8) comment '转营业外日期',
    primary  key (INTERNAL_KEY)
);
alter table MB_ACCT_DOSS comment '久悬户登记簿 undefined';