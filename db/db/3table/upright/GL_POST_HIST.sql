drop table if exists GL_POST_HIST;
/*==============================================================*/
/* Table: GL_POST_HIST                                           */
/*==============================================================*/
create table GL_POST_HIST
(
...
alter table GL_POST_HIST comment '会计分录历史表 undefined';

drop index IND_GL_POST_HIST_1 on GL_POST_HIST;
/*==============================================================*/
/* Index: IND_GL_POST_HIST_1                                           */
/*==============================================================*/
create index IND_GL_POST_HIST_1 on GL_POST_HIST (
    REFERENCE
);