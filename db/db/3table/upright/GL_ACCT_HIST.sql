drop table if exists GL_ACCT_HIST;
/*==============================================================*/
/* Table: GL_ACCT_HIST                                           */
/*==============================================================*/
create table GL_ACCT_HIST
(
    HIST_SEQ_NO varchar(50) not null comment '历史流水号',
    ...
    MANUAL_ACCOUNT varchar(1) default 'N' comment '是否允许手工记账 Y-允许,N-不允许',
    ...
    BACK_UP_DATE varchar(8) comment '备份日期',
    primary  key (HIST_SEQ_NO)
);
alter table GL_ACCT_HIST comment '总账账户历史表  undefined';