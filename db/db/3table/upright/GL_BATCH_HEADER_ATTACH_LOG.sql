drop table if exists GL_BATCH_HEADER_ATTACH_LOG;
/*==============================================================*/
/* Table: GL_BATCH_HEADER_ATTACH_LOG                                           */
/*==============================================================*/
create table GL_BATCH_HEADER_ATTACH_LOG
(
    ...
    DR_CR varchar(2) not null comment '借贷标记',
...
alter table GL_BATCH_HEADER_ATTACH_LOG comment '总行记账总行账户历史信息 undefined';