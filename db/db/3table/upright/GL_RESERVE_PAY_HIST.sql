drop table if exists GL_RESERVE_PAY_HIST;
/*==============================================================*/
/* Table: GL_RESERVE_PAY_HIST                                           */
/*==============================================================*/
create table GL_RESERVE_PAY_HIST
(
...
alter table GL_RESERVE_PAY_HIST comment '对内缴存信息 undefined';