drop table if exists MB_DEPOSIT_CERT_REC_INFO;
/*==============================================================*/
/* Table: MB_DEPOSIT_CERT_REC_INFO                                           */
/*==============================================================*/
create table MB_DEPOSIT_CERT_REC_INFO
(
    ...
    CERT_BAL Decimal(17,2) comment '证明余额',
    ...
    REPAIR_FLAG varchar(1) comment '补打原因',
    TRAN_REFERENCE varchar(50) comment '原交易参考号',
    CANCEL_USER_ID varchar(30) comment '取消柜员',
    CANCEL_AUTH_USER_ID varchar(30) comment '撤销授权柜员',
    CANCEL_DATE varchar(8) comment '取消日期',
    CANCEL_REASON varchar(200) comment '撤销原因',
    primary  key (DEPOSIT_CERT_NO,OPTION_TYPE,SEQ_NO)
);
alter table MB_DEPOSIT_CERT_REC_INFO comment '存款证明流水表 undefined';