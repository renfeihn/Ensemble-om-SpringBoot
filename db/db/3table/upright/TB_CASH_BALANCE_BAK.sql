drop table if exists TB_CASH_BALANCE_BAK;
/*==============================================================*/
/* Table: TB_CASH_BALANCE_BAK                                           */
/*==============================================================*/
create table TB_CASH_BALANCE_BAK
(
...
alter table TB_CASH_BALANCE_BAK comment '尾箱现金余额备份表 undefined';